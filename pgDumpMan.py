...
dbList = []
dbList.append(['aip','3','all','custom',''])
dbList.append(['fci','4','all','directory',''])
dbList.append(['finansonboarddev','2','all','tar',''])
dbList.append(['mobileassistant','2','all','plain',''])
########################DBLIST#######################
##################PARAMETERS##########################
clusterName = 'bauba'
...
mailTO = 'mustafa.yavuz@turkcell.com.tr'
sleepTime = 1	
writeLogFile = True
